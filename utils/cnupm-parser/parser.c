...
{  { IP(192,168,0,0),    IP(255,255,0,0),     0},
   ...
   { IP(95,138,224,0),   IP(255,255,224,0),   0},
   { IP(95,138,224,36),  IP(255,255,255,255), 1},
   { IP(95,138,225,36),  IP(255,255,255,255), 1},

   { IP(82,114,152,0),   IP(255,255,252,0),   0},

   { IP(91,213,44,0),    IP(255,255,255,0),   0},
